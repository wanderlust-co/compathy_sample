...
module RailsAssetsAngularDaterangepicker
  ...
  def self.gem_spec
    Gem::Specification::load(
      gem_path.join("rails-assets-angular-daterangepicker.gemspec").to_s
    )
  end
  ...
  def self.dependencies
    [
      ...
      RailsAssetsBootstrapDaterangepicker
    ]
  end
...
RailsAssets.components << RailsAssetsAngularDaterangepicker
