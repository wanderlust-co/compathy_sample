...
module RailsAssetsAngularBootstrapLightbox
  ...
  def self.gem_spec
    Gem::Specification::load(
      gem_path.join("rails-assets-angular-bootstrap-lightbox.gemspec").to_s
    )
  end
...
RailsAssets.components << RailsAssetsAngularBootstrapLightbox
